...
For and already initialised `BinParameters` object, the slot containing the parameter of interest can be changed by directly accessing the slot as shown below.

```{r parameterChangeExample2}
alternativeParameters <- parameters
alternativeParameters@scans <- 6:14
