...
The centrality metric is a value between 0 and 1 with a centrality close to 1 indicating that the accurate *m/z* present within the boundaries of the bin are located close to the center of the bin.
