...
```{r FIEfingerprint, echo=FALSE, fig.width=7,fig.height=5,fig.align='center',fig.show='animate',animation.hook = 'gifski',interval=0.1,dev='jpeg',aniopts=('controls,loop')}
...
Firstly, a simple intensity matrix can built for  
