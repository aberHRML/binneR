...
The *[msconvert](https://proteowizard.sourceforge.net/tools.shtml)* tool can be used for both data conversion and centroiding, allowing the use of vendor specific algorithms.
